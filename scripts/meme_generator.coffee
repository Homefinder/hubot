...
module.exports = (robot) ->
  unless robot.brain.data.memes?
    robot.brain.data.memes = [
      ...
      {
        regex: /(memegen )?(.*) (that would be great)/i,
        generatorID: 60501,
        imageID: 1431338
      },
      {
        regex: /(memegen )?(shut up and) (.*)/i,
        generatorID: 1120493,
        imageID: 4802907
      },
      {
        regex: /(memegen )?(brace yourselves) (.*)/i,
        generatorID: 121854,
        imageID: 1611300
      },
      {
      ...
      {
        regex: /(memegen )?(ha ha) (.*)/i,
        generatorID: 1365327,
        imageID: 5672157
      },
      {
        regex: /(memegen )?(f\*\*\* it) (.*)/i,
        generatorID: 674355,
        imageID: 3239759
      },
      {
        regex: /(memegen )?(You know what really grinds my gears?) (.*)/i
        generatorID: 1958,
        imageID: 233949
      }
    ]
